package com.endpoint.common.constant;
...
public enum ResponseStatus {
    ...
    SMS_CODE_EXCEPTION(1008,"短信验证码频率太高"),
    OAUTH_LOGIN_EXCEPTION(10009,"社交登录失败"),
    NO_LOGIN_ADDTO_BOOKSHELF(10010,"未登录显示加入书架"),
    BOOK_NOT_ADDTO_BOOKSHELF(10011,"小说未加入书架"),
    //评论相关错误
    ...
    AUTHOR_EXISTS(4004,"用户以注册作家"),
    AUTHOR_PEN_NAME_EXISTS(4005,"该笔名已存在"),
    AUTHOR_BOOK_NAME_EXIST(4006,"小说名已存在"),
    USER_UN_AUTH(4007,"访问未授权"),
    //搜索引擎相关错误
