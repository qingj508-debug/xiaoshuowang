  ...
  <div class="main box_center cf">
    <div class="userBox cf">
      ...
      <div class="user_r">
        ...
        <router-link to="/register" class="btn_ora_white">立即注册</router-link>
        ...
        <div class="fast_login" >
          ...
          <ul class="fast_list">
            <li class="login_wb">
              <a @click="showOauthModal('weibo')"
                ><img
                  src="../assets/images/login_weibo.png"
                  alt="微博登录"
                  class="img"
                /><span>微博登录</span></a
              >
            ...
            <li class="login_qq">
              <a href="/"
                ><img
                  src="../assets/images/login_qq.png"
                  alt="QQ登录"
                  class="img"
                /><span>QQ登录</span></a
              >
            ...
            <li class="login_wx">
              <a href="/"
                ><img
                  src="../assets/images/login_weixin.png"
                  alt="微信登录"
                  class="img"
                /><span>微信登录</span></a
              >
...
export default {
  ...
  setup() {
    ...
    const showOauthModal = (aouth)=>{ 
      //不同社交登录可以根据判断 aouth 不同传入不同的url  
      window.open(
        "https://api.weibo.com/oauth2/authorize?client_id=504454291&response_type=code&redirect_uri=http%3A%2F%2F192.168.0.107%3A9999%2F%23%2Foauth%2Flogin%2Fweibo",
        "_self"
      );
    }
